...
/**
        ...
        The main program for single threaded ClearPath-SC example. The only
command
...
*					One command-line argument is expected, which
*is the COM
*					port number for where the SC network is
*attached.
...
int main(int argc, char *argv[]) {
  ...
  // port opening,
  // the code will jump to the catch loop where detailed information regarding
  ...
  msgUser("Press any key to continue."); // pause so the user can see the error
                                         // message; waits for user to press a
                                         // key
  return returnVal;
}
//																			   *
